...
public class ResidentialBuilding implements Rescuable, Simulatable {
	...
	public void setStructuralIntegrity(int structuralIntegrity)
			throws BuildingAlreadyCollapsedException {
	...
	public String toString() {
		String s = "ResidentialBuilding:\nlocation: " + "(" + location.getX()
				+ "," + location.getY() + ")" + "\n" + "structuralIntegrity: "
				+ structuralIntegrity + "\nfireDamage: " + fireDamage
				+ "\ngasLevel: " + gasLevel + "\nfoundationDamage: "
				+ foundationDamage + "\ndisaster: ";
		if (disaster == null||getDisaster().isActive()==false) {
			s += "No disasters";
		} else {
			s += disaster.getClass().getSimpleName();
		}

		s += "\nOccupants amount: " + getOccupants().size();
