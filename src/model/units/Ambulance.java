...
public class Ambulance extends MedicalUnit {
	...
	public void respond(Rescuable r) throws IncompatibleTargetException,
		...
		if ((r instanceof ResidentialBuilding)) {
			throw new IncompatibleTargetException(this, r,"Ambulance can't treat this target change the unit please");
		}
		if(! canTreat(r)){
			throw new CannotTreatException(this, r, "there is no disasters on that citizen");
		}
